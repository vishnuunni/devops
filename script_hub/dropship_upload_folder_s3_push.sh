...
elif [ -d "$data/flipkart/productupdate" ]
then
...
elif [ -d "$data/paytm/productupdate" ]
then
...
elif [ -d "$data/paytm/processorders/W502" ]
then
...
elif [ -d "$date/limeroad/customercancelorder/W501" ]
then
...
elif [ -d "$data/limeroad/delivered/W501" ]
then
...
elif [ -d "$data/limeroad/customercancelorder/W502" ]
then
...
elif [ -d "$data/unistore/downloadorders" ]
then
...
elif [ -d "$data/unistore/listingerror" ]
then
...
elif [ -d "$data/unistore/productupdatesapi" ]
then
...
elif [ -d "$data/snapdeal/customercancelorder" ]
then
...
elif [ -d "$data/snapdeal/updateAWBnumber" ]
then
...
elif [ -d "$data/myntra/discountupdate" ]
then
...
elif [ -d "$data/myntra/invoicerequest" ]
then
...
elif [ -d "$data/myntra/orderstodropship" ]
then
...
elif [ -d "$data/myntra/productupdate" ]
then
...
elif [ -d "$data/myntra/readytodispatch" ]
then
...
elif [ -d "$data/myntra/updateorder" ]
then
